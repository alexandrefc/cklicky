<x-app-layout>
    ...
    @section('content') --}}
        ...
        <div class="sm:grid grid-cols-2 gap-20 w-4/5 mb-10 mx-auto">
            <div class="m-auto w-full sm:w-4/5 block">
                ...
                <p class="py-5 text-gray-500 text-s">
                    With our easy to use admin panel you can setup custom branded coupon, stamp & point campaings and deliver to your customers. 
                </p>

                {{-- them without a need to donwload the app --}}
        ...
        <div class="text-center py-10 bg-gray-100">
            ...
            <p class="m-auto w-4/5 text-gray-700">
                Your Customers just scan qrcode & login with their email and are set up.
            </p>
        </div>
