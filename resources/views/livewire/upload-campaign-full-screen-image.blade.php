<div class="grid grid-cols-1 mt-6 mx-7">
  <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold mb-1">Upload full screen image</label>
    <div class='flex items-center justify-center w-full'>
          ...
          <label class='flex flex-col border-4 border-dashed w-full sm:w-1/2 h-96 hover:bg-gray-100 hover:border-purple-300 group'>
              <div class='flex flex-col h-96 items-center my-auto justify-center pt-1'>
                @if ($image)
                ...
                <input name="imageFS" type="file" class="hidden" wire:model="image" >
