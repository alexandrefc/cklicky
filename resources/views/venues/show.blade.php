          ...
          {{-- <a href="" class="space-y-2 mx-auto"> --}}
            <div class="aspect-w-16 aspect-h-9">
              <img
                ...
                src="{{ asset('/images/loyalty/' . $venue->image_path) }}"
                alt=""
              />
            </div>
            ...
            <div class="px-4 py-2 mt-2">
              ...
              <div class="text-md">
                  ...
                  <p class="text:lg md:text-xl my-4 text-center bg-yellow-300 text-gray-600 font-bold py-2 px-3 rounded-3xl">
                      Total points to collect: {{ $venue->total_points ?? "" }}                   
                  </p>
                  ...
                  <div class="flex space-x-1 mb-2">
                      ...
                      <div class="flex-1 w=4/5 m-auto text-center">
                          <form 
                              action="/venues/confirmaddpoints/{{ $venue->id }}"
                              method="POST"
                              enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
            ...
            <div class="w-4/5 mt-1 mb-5 mx-auto border-b-2 border-gray-200">
                ...
                <div class="h-14 my-5">
                    <a href="{{ asset('images/qrcodes/' . $venue->qrcode_path) }}">
                        <img
                        class="w-1/4 mx-auto mt-5 shadow-md hover:shadow-xl rounded-lg"
