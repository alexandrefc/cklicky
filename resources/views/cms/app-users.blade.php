    ...
    {{-- <div> --}}
        ...
        <div x-data="{ sidebarOpen: true }" class="flex bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform  bg-gradient-to-b from-green-700 to-green-300 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
                ...
                <nav class="mt-10">
                    <a class="flex items-center mt-4 py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-white font-bold" href="/dashboard">
                                ...
                                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="text-gray-500">App Users</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{-- <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="text-gray-500">Total Offers</div>
                                        </div>
                                    </div>
                                </div>
         --}}
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="bg-white">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="text-sm leading-5 text-gray-900">{{ $user->company_name ?? "cKlicky.com user" }}</div>
                                                ...
                                                <td
                                                    ...
                                                    {{ $user->currentTeam->name }}</td>
        
                                                <td
                                                    class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                    <a href="/set-admin/{{ $user->id }}" class="text-indigo-600 hover:text-indigo-900">Set as Admin</a> <br>

                                                    <a href="/remove-admin/{{ $user->id }}" class="text-indigo-600 hover:text-indigo-900">Set as User</a>
                                                    <button>
                                                        <div class="flex space-x-1 mb-1">
                                                            <div class="flex-1 w=4/5 m-auto text-center">
                                                                ...
                                                                @method('delete')
                                                                    ...
                                                                    <button 
                                                                        type="submit"
                                                                        class=" bg-red-500 text-gray-100 text-xs font-extrabold py-1 px-2 rounded-xl">
                                                                        Delete User
                                                                    </button>
                                                                </form>
                                                            </div>
