    ...
    <div class="flex h-full bg-gray-100 items-center justify-center  pt-16 pb-32">
        ...
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
          ...
          <div class="flex justify-center">
            <div class="flex">
              <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Create stamp campaign</h1>
            </div>
          </div>
          <form 
            action="/stamps"
          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            <label class="md:text-sm text-xs text-gray-500 text-light font-extrabold">Title</label>
              <input 
                  ...
                  name="title" 
                  type="text" 
                  placeholder="eg. My First stamp card"
                  required="" />
          </div>
          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            ...
            @livewire('upload-campaign-image')
          
            @livewire('upload-campaign-full-screen-image')
          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            ...
            <select 
                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                name="category">
                  <option value="45">All categories</option>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
            ...
            <div class="grid grid-cols-1">
              <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Total stamps</label>
              <input 
                class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" 
                name="total_stamps" 
                type="number" 
          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Activate campaign</label>
              ...
              <div 
                ...
                <input class="rounded ml-3 " type="checkbox" name="is_active" id="is_active" value="1"></option>
              </div>
